...
/**
 * \brief Twiddle algorithm -- modifications applied only to simplify integration
 * \details
...
public:
     ...
     * \return True when a combination is left, False otherwise
     */
    bool next();
     ...
     * \param m Number of objects that shall be combined
